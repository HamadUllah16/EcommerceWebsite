...
function Newsletter() {
    return (
        <section className='grid grid-cols-1 lg:grid-cols-2 items-center gap-5 lg:justify-between lg:items-center rounded-3xl bg-black container mx-auto py-8 px-10 lg:gap-0 absolute -top-24 right-24'>
            <article className='text-white font-extrabold text-5xl uppercase'>
